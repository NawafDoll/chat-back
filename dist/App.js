...
app.use(express_1.default.static(path_1.default.join(__dirname, "../../front-end/my-app/build")));
app.get("*", (req, res) => {
    res.sendFile(path_1.default.resolve(__dirname, "../../front-end/my-app/build/index.html"));
});
